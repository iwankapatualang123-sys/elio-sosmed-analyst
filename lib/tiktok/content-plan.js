...
// Pilihan dropdown (dari sheet Excel) — dipakai form UI.
export const GOALS_OPTIONS = ["Awareness", "Engagement", "Consideration", "Conversion"];
export const PILLAR_OPTIONS = [
  "Awareness", "Entertaint", "Branding Person (Promotion)", "Product knowledge",
  "Emotional", "Behind The Scene", "Promotional", "Testimoni", "Telling Story",
];
export const TYPE_OPTIONS = ["Video", "Carousel", "Single Image", "Story"];
